...
namespace MiniOrange\MagentoSocialLogin\Controller\Adminhtml\Upgrade;
...
/**
 * This class handles the action for endpoint: mosocial/upgrade/Index
...
class Index extends BaseAdminAction implements HttpGetActionInterface
{
    ...
    {
        return $this->_authorization->isAllowed(SocialConstants::MODULE_DIR.SocialConstants::MODULE_UPGRADE);
    }
}
