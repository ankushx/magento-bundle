    ...
    public function aroundCreateAdminAccessToken(
        ...
        if ($shouldBlock) {
            ...
            if ($lockedAccountData && $lockedAccountData['lock_type'] === 'permanent') {
                ...
                $maxAttemptsDelayConfig = $bruteForceUtility->getStoreConfig('bruteforce/admin/max_attempts_delay', 'default', 0);
                ...
                if ($maxAttemptsDelay > 0) {
                    ...
                    if ($delayStart) {
                        $delaySeconds = $bruteForceUtility->getStoreConfig('bruteforce/admin/delay_seconds', 'default', 0) ?: 30;
