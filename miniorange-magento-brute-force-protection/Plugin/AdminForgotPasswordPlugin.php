...
class AdminForgotPasswordPlugin
{
    ...
    public function aroundExecute($subject, \Closure $proceed)
    {
        ...
        if ($subject->getRequest()->isPost()) {
            ...
            if (!empty($email)) {
                ...
                $maxAttemptsDelayConfig = $this->bruteforceutility->getStoreConfig('bruteforce/admin/forgot_password_max_attempts_delay', 'default', 0);
                $maxAttemptsDelay = ($maxAttemptsDelayConfig !== null && $maxAttemptsDelayConfig !== '') ? (int)$maxAttemptsDelayConfig : 3;
                $maxAttemptsLockoutTemporaryConfig = $this->bruteforceutility->getStoreConfig('bruteforce/admin/forgot_password_max_attempts_lockout', 'default', 0);
    ...
    protected function checkBruteForceProtection($email, $controller)
    {
        ...
        $enabled = $this->bruteforceutility->getStoreConfig('bruteforce/admin/forgot_password_enabled', 'default', 0);
        $maxAttemptsDelayConfig = $this->bruteforceutility->getStoreConfig('bruteforce/admin/forgot_password_max_attempts_delay', 'default', 0);
        $maxAttemptsDelay = ($maxAttemptsDelayConfig !== null && $maxAttemptsDelayConfig !== '') ? (int)$maxAttemptsDelayConfig : 3;
        $delaySeconds = $this->bruteforceutility->getStoreConfig('bruteforce/admin/forgot_password_delay_seconds', 'default', 0) ?: 30;
        $maxAttemptsLockoutTemporaryConfig = $this->bruteforceutility->getStoreConfig('bruteforce/admin/forgot_password_max_attempts_lockout', 'default', 0);
        $maxAttemptsLockoutTemporary = ($maxAttemptsLockoutTemporaryConfig !== null && $maxAttemptsLockoutTemporaryConfig !== '') ? (int)$maxAttemptsLockoutTemporaryConfig : 5;
        $lockoutDurationMinutes = $this->bruteforceutility->getStoreConfig('bruteforce/admin/forgot_password_lockout_duration_minutes', 'default', 0) ?: 30;
        $adminEmailTemplate = $this->bruteforceutility->getStoreConfig('bruteforce/admin/forgot_password_admin_email_template', 'default', '');
    ...
    protected function checkTemporaryLockout($email, $userId = null, $lockedAccountData = null)
    {
        ...
        $lockoutDurationMinutes = (int)$this->bruteforceutility->getStoreConfig('bruteforce/admin/forgot_password_lockout_duration_minutes', 'default', 0);
    ...
    protected function createAdminAlert($email)
    {
        try {
            ...
            $adminAlertEnabled = $this->bruteforceutility->getStoreConfig('bruteforce/admin/forgot_password_admin_alert_enabled', 'default', 0);
    ...
    {
        try {
            $emailNotificationsEnabled = $this->bruteforceutility->getStoreConfig('bruteforce/admin/forgot_password_email_notifications_enabled', 'default', 0);
