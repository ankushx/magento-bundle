...
class BruteForce extends Template
{
    ...
    {
        return $this->bruteforceutility->getStoreConfig('bruteforce/account/customer_email') ?: 'admin@example.com';
    }
    ...
    {
        return $this->bruteforceutility->getStoreConfig('bruteforce/account/customer_key') ?: 'CUST123';
    }
    ...
    public function getCustomerBruteForceSettings($websiteId = null, $storeId = null)
    {
        ...
        return [
            'enabled' => (bool)$getValue('bruteforce/customer/enabled', 0),
            'max_attempts_delay' => (int)$getValue('bruteforce/customer/max_attempts_delay', 3),
            'delay_seconds' => (int)$getValue('bruteforce/customer/delay_seconds', 30),
            'max_attempts_lockout' => (int)$getValue('bruteforce/customer/max_attempts_lockout', 5),
            'lockout_duration_minutes' => (int)$getValue('bruteforce/customer/lockout_duration_minutes', 30),
            'max_attempts_permanent_lockout' => (int)$getValue('bruteforce/customer/max_attempts_permanent_lockout', 10),
            'email_notifications_enabled' => (bool)$getValue('bruteforce/customer/email_notifications_enabled', 0),
            'email_notification_timing' => $getValue('bruteforce/customer/email_notification_timing', 'temporary'),
            'admin_alert_enabled' => (bool)$getValue('bruteforce/customer/admin_alert_enabled', 0),
            'customer_email_template_temporary' => $getValue('bruteforce/customer/customer_email_template_temporary', ''),
            'customer_email_template_permanent' => $getValue('bruteforce/customer/customer_email_template_permanent', ''),
            // Forgot Password Settings
            'forgot_password_enabled' => (bool)$getValue('bruteforce/customer/forgot_password_enabled', 0),
            'forgot_password_max_attempts_delay' => (int)$getValue('bruteforce/customer/forgot_password_max_attempts_delay', 3),
            'forgot_password_delay_seconds' => (int)$getValue('bruteforce/customer/forgot_password_delay_seconds', 30),
            'forgot_password_max_attempts_lockout' => (int)$getValue('bruteforce/customer/forgot_password_max_attempts_lockout', 5),
            'forgot_password_lockout_duration_minutes' => (int)$getValue('bruteforce/customer/forgot_password_lockout_duration_minutes', 30),
            'forgot_password_max_attempts_permanent_lockout' => (int)$getValue('bruteforce/customer/forgot_password_max_attempts_permanent_lockout', 10),
            'forgot_password_email_notifications_enabled' => (bool)$getValue('bruteforce/customer/forgot_password_email_notifications_enabled', 0),
            'forgot_password_admin_alert_enabled' => (bool)$getValue('bruteforce/customer/forgot_password_admin_alert_enabled', 0),
            'forgot_password_customer_email_template' => $getValue('bruteforce/customer/forgot_password_customer_email_template', '')
        ];
    }
    ...
    public function getAdminBruteForceSettings()
    {
        ...
        return [
            'enabled' => (bool)$getValue('bruteforce/admin/enabled', 0),
            'max_attempts_delay' => (int)$getValue('bruteforce/admin/max_attempts_delay', 3),
            'delay_seconds' => (int)$getValue('bruteforce/admin/delay_seconds', 30),
            'max_attempts_lockout' => (int)$getValue('bruteforce/admin/max_attempts_lockout', 5),
            'lockout_duration_minutes' => (int)$getValue('bruteforce/admin/lockout_duration_minutes', 30),
            'max_attempts_permanent_lockout' => (int)$getValue('bruteforce/admin/max_attempts_permanent_lockout', 10),
            'email_notifications_enabled' => (bool)$getValue('bruteforce/admin/email_notifications_enabled', 0),
            'email_notification_timing' => $getValue('bruteforce/admin/email_notification_timing', 'temporary'),
            'admin_alert_enabled' => (bool)$getValue('bruteforce/admin/admin_alert_enabled', 0),
            'admin_email_template_temporary' => $getValue('bruteforce/admin/admin_email_template_temporary', ''),
            'admin_email_template_permanent' => $getValue('bruteforce/admin/admin_email_template_permanent', ''),
            // Forgot Password Settings
            'forgot_password_enabled' => (bool)$getValue('bruteforce/admin/forgot_password_enabled', 0),
            'forgot_password_max_attempts_delay' => (int)$getValue('bruteforce/admin/forgot_password_max_attempts_delay', 3),
            'forgot_password_delay_seconds' => (int)$getValue('bruteforce/admin/forgot_password_delay_seconds', 30),
            'forgot_password_max_attempts_lockout' => (int)$getValue('bruteforce/admin/forgot_password_max_attempts_lockout', 5),
            'forgot_password_lockout_duration_minutes' => (int)$getValue('bruteforce/admin/forgot_password_lockout_duration_minutes', 30),
            'forgot_password_max_attempts_permanent_lockout' => (int)$getValue('bruteforce/admin/forgot_password_max_attempts_permanent_lockout', 10),
            'forgot_password_email_notifications_enabled' => (bool)$getValue('bruteforce/admin/forgot_password_email_notifications_enabled', 0),
            'forgot_password_admin_alert_enabled' => (bool)$getValue('bruteforce/admin/forgot_password_admin_alert_enabled', 0),
            'forgot_password_admin_email_template' => $getValue('bruteforce/admin/forgot_password_admin_email_template', ''),
        ];
    }
    ...
    {
        return (bool)$this->bruteforceutility->getStoreConfig('bruteforce/customer/enabled');
    }
    ...
    {
        return (bool)$this->bruteforceutility->getStoreConfig('bruteforce/admin/enabled');
    }
    ...
    {
        return (bool)$this->bruteforceutility->getStoreConfig('bruteforce/customer_login_logs/enabled', 'default', 0);
    }
    ...
    {
        return (int)$this->bruteforceutility->getStoreConfig('bruteforce/customer_login_logs/retention_days', 'default', 0) ?: 90;
    }
    ...
    public function isCustomerLoginLogsRetentionConfigured()
    {
        ...
        $value = $this->bruteforceutility->getStoreConfigDirect('bruteforce/customer_login_logs/retention_days', 'default', 0);
    ...
    // {
    //     $awayModeEnabled = $this->bruteforceutility->getStoreConfig('bruteforce/admin/away_mode_enabled', 'default', 0);
    //     if (!$awayModeEnabled) {
    //         return null;
    //     }
    //
    //     $fromTime = $this->bruteforceutility->getStoreConfig('bruteforce/admin/away_mode_from_time', 'default', 0) ?: '00:00:00';
    //     $toTime = $this->bruteforceutility->getStoreConfig('bruteforce/admin/away_mode_to_time', 'default', 0) ?: '23:59:59';
    //     $days = $this->bruteforceutility->getStoreConfig('bruteforce/admin/away_mode_days', 'default', 0) ?: '';
    //
    //     return [
    //         'from_time' => $fromTime,
    //         'to_time' => $toTime,
    ...
    /**
     * Check if tracking data has been added (dataadded flag)
     * @return int|null Returns 1 if data added, 0 if not, null if not set
     */
    public function checkDataAdded()
    {
        $dataAdded = $this->bruteforceutility->getStoreConfig('bruteforce/tracking/dataadded', 'default', 0);
        return $dataAdded !== null ? (int)$dataAdded : null;
    }

    /**
     * Set dataadded flag to 1 after first tracking submission
     * @return void
     */
    public function dataAdded()
    {
        $this->bruteforceutility->setStoreConfig('bruteforce/tracking/dataadded', 1, 'default', 0);
    }
    ...
    {
        $this->bruteforceutility->setStoreConfig('bruteforce/tracking/admin_email', $adminEmail, 'default', 0);
    }

    /**
     * Get timestamp for tracking
     * If dataadded is 1, retrieve existing timestamp from DB
     * If dataadded is 0 or null, generate new timestamp and save it
     * @return string
     */
    public function getTimeStamp()
    {
        ...
        if ($dataAdded == 1) {
            ...
            $timestamp = $this->bruteforceutility->getStoreConfig('bruteforce/tracking/timestamp', 'default', 0);
            if ($timestamp) {
                return $timestamp;
            }
        }
        ...
        $this->bruteforceutility->setStoreConfig('bruteforce/tracking/timestamp', $currentTimestampInMillis, 'default', 0);
