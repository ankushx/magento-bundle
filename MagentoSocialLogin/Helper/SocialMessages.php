...
class SocialMessages
{
    ...
    const AUTO_CREATE_USER_LIMIT        = "Your Auto Create User Limit for the free Miniorange Magento Social Login plugin is exceeded. Please Upgrade to any of the Premium Plan to continue the service.";
